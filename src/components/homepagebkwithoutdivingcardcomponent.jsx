...
<div className={`pg-rating new-rating ${!isSubscribed ? "blurred" : ""}`}>                                <FaStar className="star" />
<span>{Number(pg.rating).toFixed(1)}</span>
                              </div>
                            </div>

                            {/* Location */}
                            <p className={`pg-location new-location ${!isSubscribed ? "blurred" : ""}`}>
  {pg.location}, {pg.city || ""}
</p>
...
<div className={`facilities-grid ${!isSubscribed ? "blurred" : ""}`}>                                {pg.facilities.map((facility, i) => (
                              ...
                              <div className="pricecard">
                                <span className="price-label">Starts From: <span className={`PriceNo ${!isSubscribed ? "blurred" : ""}`}>
  {pg.price}
</span>/month  </span>
                            </div>
